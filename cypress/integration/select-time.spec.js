...
describe('select time - range', () => {
    ...
    it('with click on times', () => {
        ...
        cy.get('.pdp-input').should('have.value', '20:18 - 15:12')
    })
    ...
    it('with type the time', () => {
        cy.visit('/')
        cy.tab().type('20:18{enter}').type('15:12{enter}')
        cy.get('.pdp-input').should('have.value', '20:18 - 15:12')
    })
})
...
describe('select date with disable date - range', () => {
    ...
    it('with click on times', () => {
        ...
        cy.get('.pdp-input').should('have.value', '20:19 - 15:13')
        cy.get('.pdp-time .pdp-moment > div:last-child .minute button:last-child').click()
        cy.get('.pdp-input').should('have.value', '20:19 - 15:11')
    })
    ...
    it('with keys', () => {
        ...
        cy.get('.pdp-time .pdp-moment > div:last-child').should('have.attr', 'class').and('match', /disabled/)
        cy.get('.pdp-input').should('have.value', '20:19 - 15:13')
        cy.get('.pdp-moment button').eq(7).focus().type('{enter}')
        cy.get('.pdp-input').should('have.value', '20:19 - 15:11')
    })

    it('with type the time', () => {
        cy.visit('/')
        cy.tab().type('20:18{enter}')
        cy.get('.pdp-input').should('have.value', '20:18')
        cy.get('.hour').should('not.contain.value', '20')
        cy.get('.minute').should('not.contain.value', '18')
        cy.get('.pdp-input').clear().type('20:19{enter}').type('15:12{enter}')
        cy.get('.pdp-input').should('have.value', '15:12')
        cy.get('.hour').should('not.contain.value', '15')
        cy.get('.minute').should('not.contain.value', '12')
        cy.get('.pdp-input').clear().type('15:11{enter}')
        cy.get('.pdp-input').should('have.value', '20:19 - 15:11')
    })
})