...
describe('arrow keys in "en" locale', () => {
    ...
    it('with select date', () => {
        ...
        cy.get('.pdp-input').should('have.value', '2020-04-02 - 2020-04-29')
        cy.get('.pdp-input').focus().get('.end-range').should('contain.text', '29')
        ...
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{enter}')
        cy.get('.pdp-input').should('have.value', '2020-04-13 - 2020-05-25')
        cy.get('.pdp-input').focus().get('.end-range').should('contain.text', '25')
        cy.get('.pdp-arrow').first().click().click()
        cy.get('.pdp-input').type('{uparrow}{uparrow}{uparrow}{enter}', { force: true })
        ...
        cy.get('.pdp-input').should('have.value', '2020-03-23 - 2020-04-22')
        cy.get('.pdp-input').focus().get('.end-range').should('contain.text', '22')
