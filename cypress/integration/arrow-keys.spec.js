...
describe('arrow keys', () => {
    ...
    it('with select date', () => {
        ...
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{enter}')
            .get('.start-range').should('contain.text', '26')
        cy.get('.pdp-arrow').first().click().click()
        cy.get('.pdp-input').type('{uparrow}{enter}', { force: true })
            .should('have.value', '1399/01/01 - 1399/03/26').focus()
...
describe('arrow keys in "en" locale', () => {
    ...
    it('with select date', () => {
        ...
        cy.get('.pdp-input').type('{uparrow}{uparrow}{uparrow}{enter}')
            .should('have.value', '2020-04-13 - 2020-05-04').focus()
        cy.get('.start-range').should('contain.text', '13')
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{enter}')
        cy.get('.start-range').should('contain.text', '25')
        cy.get('.pdp-arrow').first().click().click()
        cy.get('.pdp-input')
            .type('{downarrow}{downarrow}{downarrow}{downarrow}{rightarrow}{rightarrow}{enter}', { force: true })
            .should('have.value', '2020-04-12 - 2020-05-25')
            .focus().get('.start-range').should('contain.text', '12')
