...
describe('arrow keys', () => {
    ...
    it('with select date', () => {
        ...
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{enter}')
            .should('have.value', '1399/01/25 - 1399/03/05')
            .focus().get('.end-range').should('contain.text', '5')
        ...
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{leftarrow}{leftarrow}{enter}')
            .should('have.value', '1399/01/04 - 1399/02/03')
            .focus().get('.end-range').should('contain.text', '3')
...
describe('arrow keys in "en" locale', () => {
    ...
    it('without select date', () => {
        ...
        cy.get('[data-column=0] .hover').should('contain.text', '31')
        cy.get('.pdp-input').type('{uparrow}{leftarrow}{leftarrow}{leftarrow}{leftarrow}{leftarrow}{leftarrow}')
    ...
    it('with select date', () => {
        ...
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{leftarrow}{enter}')
            .should('have.value', '2020-04-02 - 2020-04-29')
            .focus().get('.end-range').should('contain.text', '29')
        cy.get('[data-column=1] .in-range').first().should('not.contain.text', '2').should('not.contain.text', '1')
        cy.get('[data-column=1] .in-range').last().should('not.contain.text', '29').should('not.contain.text', '30')
        cy.get('.pdp-input').type('{downarrow}{leftarrow}{leftarrow}{enter}')
        cy.get('.start-range').should('contain.text', '4')
        cy.get('.pdp-input').type('{uparrow}{uparrow}{uparrow}{enter}')
        cy.get('.start-range').should('contain.text', '13')
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{downarrow}{enter}')
            .should('have.value', '2020-04-13 - 2020-05-25')
            .focus().get('.end-range').should('contain.text', '25')
        cy.get('.pdp-arrow').first().click().click()
        cy.get('.pdp-input').type('{uparrow}{uparrow}{uparrow}{enter}', { force: true })
        cy.get('.start-range').should('contain.text', '23')
        cy.get('.pdp-input').type('{downarrow}{downarrow}{downarrow}{downarrow}{rightarrow}{rightarrow}{enter}')
            .should('have.value', '2020-03-23 - 2020-04-22')
            .focus().get('.end-range').should('contain.text', '22')
...
describe('arrow keys in "en" locale', () => {
    ...
    it('with select date', () => {
        ...
        cy.get('.pdp-input').type('{downarrow}{downarrow}{leftarrow}{leftarrow}{enter}')
            ...
            .focus().get('.end-range').should('contain.text', '9')
